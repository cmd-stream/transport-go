// Package server provides a mock implementation of the server codec.
package server
...
type (
	DecodeFn func(r transport.Reader) (seq core.Seq, cmd core.Cmd[any], n int, err error)
	EncodeFn func(seq core.Seq, result core.Result, w transport.Writer) (n int, err error)
)
...
func (c ServerCodec) RegisterDecode(fn DecodeFn) ServerCodec {
	c.Register("Decode", fn)
	return c
}

func (c ServerCodec) RegisterEncode(fn EncodeFn) ServerCodec {
